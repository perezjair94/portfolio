export default function TechnicalTestCard({ title, link, image }) {
  return (
      ...
      <div>
        <a href={link} target="_blank">
          <div className="relative">
            ...
            <div
              className="relative w-full h-56 rounded-md opacity-95"
              style={{
                background: `url(/images/technical-test/${image})`,
